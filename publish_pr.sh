...
git push -u origin "$SOURCE_BRANCH" || handle_error
python /home/r/workspace/lazygit/lazy_push_handler.py "$REPO_NAME" --source "$SOURCE_BRANCH" --target "$DEFAULT_BRANCH" --message "$TITLE" "$@" || handle_error
